...
def source_to_function(source: str) -> Tuple[List[compiler.Byte], compiler.Values]:
    """ """
    ...
    return function.bytecode, values


def test_expression() -> None:
    """ """
    bytecode, vector = source_to_function(source="1 - (2 + 3);")
    ...
    bytecode, vector = source_to_function(source="5 * (2 - (3 + 4));")
...
def test_assignment() -> None:
    """ """
    bytecode, vector = source_to_function(source="let a; print a;")
    ...
    bytecode, vector = source_to_function(source="let a = 1; print a;")
    ...
    bytecode, vector = source_to_function(source="let a = 1; a = 2; print a + 3;")
...
def test_scope() -> None:
    """ """
    bytecode, vector = source_to_function(
        source="""\
let a = 1;
{
    let a = 10;
